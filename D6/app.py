...
#sudo docker build . -t flask_heroku:1.0.0

#sudo docker images

#sudo docker run -d -p 5000:5000 flask_heroku:1.0.0

#http://localhost:5000/predict?sl=1.2&sw=1.7&pl=1.8&pw=2.1
...
#https://<your_app_name>.herokuapp.com/predict?sl=1.2&sw=1.7&pl=1.8&pw=2.1
